...
from app.api.v1.endpoints.admin_delivery import router as admin_delivery_router
...
from app.api.v1.endpoints.admin_terms import router as admin_terms_router
